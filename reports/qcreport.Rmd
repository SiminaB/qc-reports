...
QCmetricsLongPrecInt_ALL <- melt_by_fraction(QCmetrics, "PrecursorIntensityALL")

##Create data frame melting the precursor MZ values
QCmetricsLongPrecMZ_ALL <- melt_by_fraction(QCmetrics, "PrecursorMZALL")

##Create data frame melting the precursor MW values
QCmetricsLongPrecMW_ALL <- melt_by_fraction(QCmetrics, "PrecursorMWALL") 

##Create data frame melting the MS2perMS values
QCmetricsLongMS2perMS_ALL <- melt_by_fraction(QCmetrics, "MS2perMS1ALL")  

##Create data frame melting MS2 charge ratio
QCmetricsLongMS2Charge_ALL <- melt_by_fraction(QCmetrics, "MS2chargeALL")  
...
QCmetricsPeptideRd <- melt_by_fraction(QCmetrics, "PeptideRd")
  
# Create data frame melting Retention Time All
QCmetricsPeptideRT_ALL <- melt_by_fraction(QC_metrics, "RetentionTimeALL") 
...
##Create data frame melting the precursor intensities
QCmetricsLongPrecInt_ID <- melt_by_fraction(QCmetrics, "PrecursorIntensityID") 

##Create data frame melting the precursor MZ values
QCmetricsLongPrecMZ_ID <- melt_by_fraction(QCmetrics, "PrecursorMZID") 

##Create data frame melting the precursor MW values
QCmetricsLongPrecMW_ID <- melt_by_fraction(QCmetrics, "PrecursorMWID") 

##Create data frame melting the MS2perMS values
QCmetricsLongMS2perMS_ID <- melt_by_fraction(QCmetrics, "MS2perMS1") 

##Create data frame melting MS2 charge ratio
QCmetricsLongMS2Charge_ID <- melt_by_fraction(QCmetrics, "MS2chargeID")  
...
QCmetricsPeptideRT_ID <- melt_by_fraction(QCmetrics, "RetentionTimeID") 
```
...
gg_pfp_plotly_all_id(QCmetricsLongPrecInt_ALL, QCmetricsLongPrecInt_ID,
                     ...
                     max_y_all=max(pmas_ALL, Pmax_ALL),
                     min_y_id=min(Pmin_ALL,Pmin_ID), 
                     min_x_id=max(Pmax_ALL, Pmax_ID),
...
gg_pfp_plotly_all_id(QCmetricsLongPrecMZ_ALL, QCmetricsLongPrecMZ_ID,
                     ...
                     min_y_id=find_min(QCmetricsLongPrecMZ_ALL,
                                       QCmetricsLongPrecMZ_ID), 
                     min_x_id=find_max(QCmetricsLongPrecMZ_ALL,
                                       QCmetricsLongPrecMZ_ID),
                     annot_all_1=all_spect_title_grid,
                     annot_all_2=fr_title,
                     annot_id_1=id_spect_title_grid,
...
gg_pfp_plotly_all_id(QCmetricsLongPrecMW_ALL, QCmetricsLongPrecMW_ID,
                     ...
                     min_y_id=find_min(QCmetricsLongPrecMW_ALL,
                                       QCmetricsLongPrecMW_ID), 
                     min_x_id=find_max(QCmetricsLongPrecMW_ALL,
                                       QCmetricsLongPrecMW_ID),
                     annot_all_1=all_spect_title_grid,
                     annot_all_2=fr_title,
                     annot_id_1=id_spect_title_grid,
...
gg_pfp_plotly_all_id(QCmetricsLongMS2perMS_ALL, QCmetricsLongMS2perMS_ID,
                     ...
                     min_y_id=find_min(QCmetricsLongMS2perMS_ALL,
                                       QCmetricsLongMS2perMS_ID), 
                     min_x_id=find_max(QCmetricsLongMS2perMS_ALL,
                                       QCmetricsLongMS2perMS_ID),
                     annot_all_1=all_spect_title_grid,
                     annot_all_2=fr_title,
                     annot_id_1=id_spect_title_grid,
...
gg_pfp_plotly_all_id(QCmetricsPeptideRT_ALL, QCmetricsPeptideRT_ID,
                     ...
                     min_y_id=find_min(QCmetricsPeptideRT_ALL,
                                       QCmetricsPeptideRT_ID), 
                     min_x_id=find_max(QCmetricsPeptideRT_ALL,
                                       QCmetricsPeptideRT_ID),
                     annot_all_1=all_spect_title_grid,
                     annot_all_2=fr_title,
                     annot_id_1=id_spect_title_grid,
